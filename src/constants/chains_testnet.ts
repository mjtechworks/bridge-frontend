export const testNetworks = {
  ...
  //   tokenSymbolList: ["CELR", "USDT", "WETH", "MCB", "PSP", "PCE", "MELI", "FUSD", "FLOW"],
  // },
  // ropsten: {
  ...
  Avalanche: {
    ...
    tokenSymbolList: ["WFBC"],
  },
  FoundationBlockchain: {
    name: "FBC",
    color: "#3099f2",
    chainId: 143,
    rpcUrl: "https://18.220.100.80:8545/ext/bc/2K3dcYdbS5YQR6rFz9BZ2qvb7RJALQbMe2BLyDKorBXuHiGY8Z/rpc",
    blockTime: 5000,
    iconUrl: "./arbitrum.png",
    blockDelay: 15,
    symbol: "FBC",
    blockExplorerUrl: "http://18.220.100.80:4000",
    tokenSymbolList: ["WFBC"],
  }
  // Optimism: {
  //   name: "Optimism",
  ...
  //   tokenSymbolList: ["FUSD", "FLOW", "USDC"],
  //   contractAddr: "0x358234B325EF9eA8115291A8b81b7d33A2Fa762D",
  ...
  //   tokenSymbolList: ["WETH", "USDC", "MATIC"],
